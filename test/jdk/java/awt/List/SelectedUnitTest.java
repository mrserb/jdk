 ...
 */
public final class SelectedUnitTest {

    public static void main(String[] args) {
        // non-displayable list
        testSingleSelectionMode(null);
        testMultipleSelectionMode(null);
        testEmptySelection(null);

        // displayable list
        testDisplayable(SelectedUnitTest::testSingleSelectionMode);
        testDisplayable(SelectedUnitTest::testMultipleSelectionMode);
        testDisplayable(SelectedUnitTest::testEmptySelection);
    }
    ...
    private static void testDisplayable(Test test) {
        ...
        try {
            ...
            test.execute(frame);
            testEmptySelection(frame);
        } finally {
            frame.dispose();
        }
    }

    private static void testSingleSelectionMode(Frame frame) {
    ...
    private static void testMultipleSelectionMode(Frame frame) {
