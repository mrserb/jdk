...
/**
 * The {@code DropTargetDropEvent} is delivered via the
 * {@code DropTargetListener} drop() method.
 * <p>
 * The {@code DropTargetDropEvent} reports the <i>source drop actions</i> and
...
public class DropTargetDropEvent extends DropTargetEvent {
    ...
    /**
     * Construct a {@code DropTargetDropEvent} given the
     * {@code DropTargetContext} for this operation, the location of the drag
     * {@code Cursor}'s hotspot in the {@code Component}'s coordinates, the
     * currently selected user drop action, and the current set of actions
     * supported by the source. By default, this constructor assumes that the
    ...
    /**
     * Construct a {@code DropTargetEvent} given the {@code DropTargetContext}
     * for this operation, the location of the drag {@code Cursor}'s hotspot in
     * the {@code Component}'s coordinates, the currently selected user drop
     * action, the current set of actions supported by the source, and a
    ...
    /**
     * This method returns the currently available {@code DataFlavor}s as a
     * {@code java.util.List}.
     *
    ...
    /**
     * This method returns the {@code Transferable} object associated with the
     * drop.
     *
