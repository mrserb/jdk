...
/**
 * The {@code DropTargetListener} interface is the callback interface used by
 * the {@code DropTarget} class to provide notification of DnD operations that
 * involve the subject {@code DropTarget}. Methods of this interface may be
 * implemented to provide "drag under" visual feedback to the user throughout
 * the Drag and Drop operation.
 * <p>
 * Create a listener object by implementing the interface and then register it
 * with a {@code DropTarget}. When the drag enters, moves over, or exits the
 * operable part of the drop site for that {@code DropTarget}, when the drop
 * action changes, and when the drop occurs, the relevant method in the listener
 * object is invoked, and the {@code DropTargetEvent} is passed to it.
 * <p>
...
public interface DropTargetListener extends EventListener {
     ...
     * part of the drop site for the {@code DropTarget} registered with this
     * listener.
     * <p>
     ...
     * performed via the returned {@code Transferable}'s getTransferData()
     * method.
     * <p>
