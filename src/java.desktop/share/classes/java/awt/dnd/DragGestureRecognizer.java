...
/**
 * The {@code DragGestureRecognizer} is an abstract base class for the
 * specification of a platform-dependent listener that can be associated with a
 * particular {@code Component} in order to identify platform-dependent drag
 * initiating gestures.
 * <p>
 * The appropriate {@code DragGestureRecognizer} subclass instance is obtained
 * from the {@link DragSource} associated with a particular {@code Component},
 * or from the {@code Toolkit} object via its
 * {@link java.awt.Toolkit#createDragGestureRecognizer
 * createDragGestureRecognizer()} method.
 * <p>
 * Once the {@code DragGestureRecognizer} is associated with a particular
 * {@code Component} it will register the appropriate listener interfaces on
 * that {@code Component} in order to track the input events delivered to the
 * {@code Component}.
 * <p>
 * Once the {@code DragGestureRecognizer} identifies a sequence of events on the
 * {@code Component} as a drag initiating gesture, it will notify its unicast
 * {@code DragGestureListener} by invoking its
 * {@link java.awt.dnd.DragGestureListener#dragGestureRecognized
 * gestureRecognized()} method.
 * <p>
 * When a concrete {@code DragGestureRecognizer} instance detects a drag
 * initiating gesture on the {@code Component} it is associated with, it fires a
 * {@link DragGestureEvent} to the {@code DragGestureListener} registered on its
 * unicast event source for {@code DragGestureListener} events. This
 * {@code DragGestureListener} is responsible for causing the associated
 * {@code DragSource} to start the Drag and Drop operation (if appropriate).
 *
...
public abstract class DragGestureRecognizer implements Serializable {
     ...
     * {@code DragSource} to be used in this Drag and Drop operation, the
     * {@code Component} this {@code DragGestureRecognizer} should "observe" for
     * drag initiating gestures, the action(s) supported for this Drag and Drop
    ...
    /**
     * Construct a new {@code DragGestureRecognizer} given the
     * {@code DragSource} to be used in this Drag and Drop operation, and the
     * {@code Component} this {@code DragGestureRecognizer} should "observe" for
    ...
    /**
     * This method returns the {@code DragSource} this
     * {@code DragGestureRecognizer} will use in order to process the Drag and
     * Drop operation.
     *
    ...
    /**
     * This method returns the {@code Component} that is to be "observed" by the
     * {@code DragGestureRecognizer} for drag initiating gestures.
     *
     ...
     * <p>
     * registerListeners() and unregisterListeners() are called as a side effect
     * as appropriate.
     *
    ...
    /**
     * This method returns an int representing the type of action(s) this Drag
     * and Drop operation will support.
     *
    ...
    /**
     * This method sets the permitted source drag action(s) for this Drag and
     * Drop operation.
     *
    ...
    /**
     * This method returns the first event in the series of events that
     * initiated the Drag and Drop operation.
     *
     ...
     * Events that are recognized as part of the series of Events that go to
     * comprise a Drag and Drop initiating gesture via this API.
     * <p>
     * This method is used by a {@code DragGestureRecognizer} implementation to
     * add an {@code InputEvent} subclass (that it believes is one in a series
     * of events that comprise a Drag and Drop operation) to the array of events
     * that this {@code DragGestureRecognizer} maintains internally.
     *
     * @param  awtie the {@code InputEvent} to add to this
     *         {@code DragGestureRecognizer}'s internal array of events. Note
     *         that {@code null} is not a valid value, and will be ignored.
     */
    ...
    /**
     * Serializes this {@code DragGestureRecognizer}. This method first performs
     * default serialization. Then, this object's {@code DragGestureListener} is
     ...
     * performs default deserialization for all non-{@code transient} fields.
     * This object's {@code DragGestureListener} is then deserialized as well by
    ...
    /**
     * The {@code DragSource} associated with this
     * {@code DragGestureRecognizer}.
     *
     * @serial
     */
    ...
    /**
     * The {@code DragGestureListener} associated with this
     * {@code DragGestureRecognizer}.
     */
    protected transient DragGestureListener dragGestureListener;

    /**
     * An {@code int} representing the type(s) of action(s) used in this Drag
     * and Drop operation.
     *
     * @serial
     */
  protected int  sourceActions;
    ...
    /**
     * The list of events (in order) that the {@code DragGestureRecognizer}
