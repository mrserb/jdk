...
class DnDEventMulticaster extends AWTEventMulticaster
     ...
     * listener-b. Input parameters {@code a} and {@code b} should not be
     * {@code null}, though implementations may vary in choosing whether or not
     * to throw {@code NullPointerException} in that case.
     *
     * @param  a listener-a
     * @param  b listener-b
     */
    ...
    /**
     * Handles the {@code DragSourceDragEvent} by invoking {@code dragEnter} on
    ...
    /**
     * Handles the {@code DragSourceDragEvent} by invoking {@code dragOver} on
     * listener-a and listener-b.
     *
     * @param  dsde the {@code DragSourceDragEvent}
     */
    ...
    /**
     * Handles the {@code DragSourceEvent} by invoking {@code dragExit} on
     * listener-a and listener-b.
     *
    ...
    /**
     * Handles the {@code DragSourceDropEvent} by invoking {@code dragDropEnd}
    ...
    /**
     * Adds drag-source-listener-a with drag-source-listener-b and returns the
    ...
    /**
     * Removes the old drag-source-listener from drag-source-listener-l and
     * returns the resulting multicast listener.
     *
     ...
     * creates and returns a new AWTEventMulticaster instance which chains a
     * with b.
     *
     ...
     * AWTEventMulticaster, then it removes the old listener from it. Else,
     * returns listener l.
     *
