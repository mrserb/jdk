 ...
 * {@code DragSourceAdapter} class (overriding only the methods of interest).
 * <p>
 * Create a listener object using that class and then register it with a
 * {@code DragSource}. Whenever the mouse moves during a drag operation
 * initiated with this {@code DragSource}, that object's {@code dragMouseMoved}
 * method is invoked, and the {@code DragSourceDragEvent} is passed to it.
 *
